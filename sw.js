/* Istante v3.2.0: versioned app shell only. Streams and third-party APIs are never intercepted. */
'use strict';
const PREFIX='istante-'+encodeURIComponent(self.registration.scope)+'-';
const CACHE=PREFIX+'3.2.0';
const VERSION='?v=3.2.0';
const FILES=['./','./index.html','./manifest.webmanifest',
 './assets/icons/icon.svg','./assets/icons/icon-192.png','./assets/icons/icon-512.png',
 './assets/css/app.css'+VERSION,'./assets/css/interactions.css'+VERSION,'./data/phrases.js'+VERSION,'./data/stations.js'+VERSION,
 ...['core','solar','icons','typing','effects','radio','motion','controls','experience','time-core','moments','main'].map(n=>'./assets/js/'+n+'.js'+VERSION)];
