...
const OPTIONAL=["./leggi.html","./README.md","./CHANGELOG.md","./docs/release/v3.14.0.md","./docs/LICENZA.md","./docs/TERZE-PARTI.md","./docs/VISIONE-E-DESIGN.md","./assets/css/documents.css","./assets/js/documents.js","./assets/vendor/fonts/excalifont/Excalifont-Regular.woff2","./assets/vendor/fonts/libre-baskerville/LibreBaskerville-VariableFont_wght.ttf","./assets/vendor/fonts/libre-baskerville/LibreBaskerville-Italic-VariableFont_wght.ttf","./assets/vendor/fonts/excalifont/NOTICE.md","./assets/vendor/fonts/libre-baskerville/NOTICE.md"];
