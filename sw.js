...
const VERSION=PREFIX+'original-1.1.0';
const FILES=['./','./index.html','./style.css?v=original-1.1','./original.css?v=original-1.1','./core.js?v=original-1.1','./solar.js?v=original-1.1','./controls.js?v=original-1.1','./experience.js?v=original-1.1','./main.js?v=original-1.1','./data/phrases.js','./data/frasi_motivazionali_700.json','./manifest.webmanifest','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
