...
const defaults:SettingsData={theme:'auto',clock24:true,showSeconds:false,typewriter:true,background:'photo',photoSeed:'daily',weatherEnabled:false,followSun:true,uiScale:1}
