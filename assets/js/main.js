/* Istante v3.14.0 - application and local preferences. */
(function () {
'use strict';
...
function updateViewportIndex(){
 ...
 if(metrics){document.body.dataset.viewportShape=metrics.shape;document.body.dataset.viewportLayout=metrics.layout;return;}
 ...
 root.dataset.viewportShape=shape;document.body.dataset.viewportShape=shape;
}
