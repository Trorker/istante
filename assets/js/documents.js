...
(function(){'use strict';
 const documents={
  progetto:{path:'README.md',label:'Il progetto'},novita:{path:'CHANGELOG.md',label:'Tutte le novit\u00e0'},release:{path:'docs/release/v3.13.1.md',label:'Release 3.13.1'},visione:{path:'docs/VISIONE-E-DESIGN.md',label:'Visione e design'},
